...
export default function Header() {
  return (
    <header className="z-10 pointer-events-none flex items-center justify-between w-full px-4 my-2 max-w-screen-xl mx-auto">
      <svg
      ...
      <div className="flex gap-4">
        ...
        <svg
          className="hidden pointer-events-auto cursor-pointer"
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
          viewBox="0 0 24 24"
